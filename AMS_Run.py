...
# Load the foreground image or project content
...
# GUI for manually fill attendanc
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:\Program Files\JetBrains\PyCharm Community Edition 2022.3.3\face\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Program Files\JetBrains\PyCharm Community Edition 2022.3.3\face\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:\Program Files\JetBrains\PyCharm Community Edition 2022.3.3\face\Face-Recognition-Attendance-System-main\ ' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Program Files\JetBrains\PyCharm Community Edition 2022.3.3\face\Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'zaman':
            if password == 'zaman123':
                ...
                cs = r'C:\Program Files\JetBrains\PyCharm Community Edition 2022.3.3\face\Face-Recognition-Attendance-System-main\StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-System", bg="olive", fg="white", width=50,
...
AP = tk.Button(window, text="Check Registered students", command=admin_panel, fg="black",
               bg="khaki", width=19, height=1, activebackground="white", font=('times', 15, ' bold '))
AP.place(x=990, y=410)

takeImg = tk.Button(window, text="Take Images", command=take_img, fg="black", bg="khaki",
                    width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images", fg="black", command=trainimg, bg="khaki",
                     width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance", fg="black", command=subjectchoose,
               bg="khaki", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
